...
app = Flask(__name__)
CORS(app)
app.config["SECRET_KEY"] = "05a23a3d4636426f82680872afcc45a8" # secure key, this help the JWT to be signed
...
def token_required(func):
    ...
    def decorated(*args, **kwargs):
        ...
        # Check if the 'Authorization' header exists in the incoming request
        ...
        # If no token was found, return a 401 Unauthorized error
        if not token:
        ...
        try:
            ...
            # Call the original function and pass the current_user to it
...
@token_required
def get_temperature_history(current_user):
